...
Процедура КоличествоПриИзменении(Элемент)
	...
	Попытка
		...
		Если ЗначениеЗаполнено(СокрЛП(Количество)) И ТипЗнч(ЧислоКоличество) = тип("Число") тогда
			...
			//или ???
			КоличествоДобавить = Число(СокрЛП(Количество)) * ПолучитьКоэффициентУпаковкиНаСервере(Упаковка); 	// да , наверно так, так правильнее
			...
			Ответ = Новый Структура("Номенклатура, Упаковка, МинимУпаковка, КоличествоДобавить", Номенклатура, , Упаковка, КоличествоДобавить);
